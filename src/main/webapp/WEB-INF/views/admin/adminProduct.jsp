                    ...
                    <main class="main">
                        ...
                        <div class="main-header">
                            ...
                            <div class="header-right">
                                <a href="admin/adminAddProd.htm" class="btn-add-prod"><i class="fa-solid fa-plus"></i>Add product</a>
                            </div>
                        </div>
                                ...
                                <table>
                                    ...
                                    <div class="scroll">
                                        <tr>
                                            ...
                                            <td>Small</td>
                                            <td>1</td>
                                            <td><a href="admin/adminEditProd.htm" class="icon"><i class="fa-solid fa-pen"></i></a></td>
